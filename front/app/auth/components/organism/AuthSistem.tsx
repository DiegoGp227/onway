        ...
        <AnimatePresence mode="wait" custom={isLogin}>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-1">
              {isLogin ? (
                <>
                  <h2 className="font-bold text-3xl text-text tracking-tight">Welcome back</h2>
                  <p className="text-text-muted text-sm">Sign in to continue to your workspace</p>
                </>
              ) : (
                <>
                  <h2 className="font-bold text-3xl text-text tracking-tight">Create account</h2>
                  <p className="text-text-muted text-sm">Start building your workflow today</p>
                </>
              )}
            </div>
