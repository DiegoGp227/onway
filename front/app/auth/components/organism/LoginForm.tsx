            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3.5 bg-bg/80 border border-border rounded-xl text-text placeholder:text-text-dim focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/10 transition-all duration-200"
